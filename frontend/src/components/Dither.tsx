...
function DitheredWaves({
  ...
  useFrame(({ clock }) => {
    ...
    if ((u.waveSpeed.value as number) !== waveSpeed) u.waveSpeed.value = waveSpeed
    if ((u.waveFrequency.value as number) !== waveFrequency) u.waveFrequency.value = waveFrequency
    if ((u.waveAmplitude.value as number) !== waveAmplitude) u.waveAmplitude.value = waveAmplitude
    ...
    if (enableMouseInteraction) u.mousePos.value = mouseRef.current
  })
